...
const validateForm = ({
  ...
  if (deliveryProvinceCode === DEFAULT_PROVINCE_VALUE) err.deliveryProvinceCode = 'Tỉnh/Thành Phố không được trống';
  if (deliveryDistrictCode === DEFAULT_DISTRICT_VALUE) err.deliveryDistrictCode = 'Quận/Huyện không được trống';
  if (deliveryWardCode === DEFAULT_WARD_VALUE) err.deliveryWardCode = 'Phường/Xã phố không được trống';
